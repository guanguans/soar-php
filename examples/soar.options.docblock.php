 ...
 * @method self setAllowDropIndex(mixed $allowDropIndex)
 *
 * AllowEngines (default "innodb")
 * @method self setAllowEngines(string $allowEngines)
 *
 * AllowOnlineAsTest, 允许线上环境也可以当作测试环境
 * @method self setAllowOnlineAsTest(mixed $allowOnlineAsTest)
 *
 * 指定 blacklist 配置文件的位置，文件中的 SQL 不会被评审。一行一条SQL，可以是指纹，也可以是正则
 * @method self setBlacklist(string $blacklist)
 *
 * Check configs
 * @method self setCheckConfig(mixed $checkConfig)
 *
 * 单次运行清理历史1小时前残余的测试库。
 * @method self setCleanupTestDatabase(mixed $cleanupTestDatabase)
 *
 ...
 * @method self setDropTestTemporary(mixed $dropTestTemporary)
 *
 * 是否在预演环境执行 (default true)
 * @method self setDryRun(mixed $dryRun)
 *
 * Explain, 是否开启Explain执行计划分析 (default true)
 * @method self setExplain(mixed $explain)
 *
 ...
 * @method self setListHeuristicRules(mixed $listHeuristicRules)
 *
 * ListReportTypes, 打印支持的报告输出类型
 * @method self setListReportTypes(mixed $listReportTypes)
 *
 * ListRewriteRules, 打印支持的重写规则列表
 * @method self setListRewriteRules(mixed $listRewriteRules)
 *
 * ListTestSqls, 打印测试case用于测试
 * @method self setListTestSqls(mixed $listTestSqls)
 *
 ...
 * @method self setLogErrStacks(mixed $logErrStacks)
 *
 ...
 * @method self setOnlySyntaxCheck(mixed $onlySyntaxCheck)
 *
 * Print configs
 * @method self setPrintConfig(mixed $printConfig)
 *
 * Profiling, 开启数据采样的情况下在测试环境执行Profile
 * @method self setProfiling(mixed $profiling)
 *
 ...
 *
 * Sampling, 数据采样开关
 * @method self setSampling(mixed $sampling)
 *
 ...
 *
 * ShowLastQueryCost
 * @method self setShowLastQueryCost(mixed $showLastQueryCost)
 *
 * ShowWarnings
 * @method self setShowWarnings(mixed $showWarnings)
 *
 ...
 * @method self setTrace(mixed $trace)
 *
 * UkPrefix (default "uk_")
 * @method self setUniqueKeyPrefix(string $uniqueKeyPrefix)
 *
 * Verbose
 * @method self setVerbose(mixed $verbose)
 *
 * Print version info
 * @method self setVersion(mixed $version)
 *
 * Help
 * @method self setHelp(mixed $help)
 *
 * AllowCharsets (default "utf8,utf8mb4")
 ...
 *
 * AllowDropIndex, 允许输出删除重复索引的建议
 * @method self withAllowDropIndex(mixed $allowDropIndex)
 *
 * AllowEngines (default "innodb")
 * @method self withAllowEngines(string $allowEngines)
 *
 * AllowOnlineAsTest, 允许线上环境也可以当作测试环境
 * @method self withAllowOnlineAsTest(mixed $allowOnlineAsTest)
 *
 * 指定 blacklist 配置文件的位置，文件中的 SQL 不会被评审。一行一条SQL，可以是指纹，也可以是正则
 * @method self withBlacklist(string $blacklist)
 *
 * Check configs
 * @method self withCheckConfig(mixed $checkConfig)
 *
 * 单次运行清理历史1小时前残余的测试库。
 * @method self withCleanupTestDatabase(mixed $cleanupTestDatabase)
 *
 * ColumnNotAllowType (default "boolean")
 ...
 *
 * DropTestTemporary, 是否清理测试环境产生的临时库表 (default true)
 * @method self withDropTestTemporary(mixed $dropTestTemporary)
 *
 * 是否在预演环境执行 (default true)
 * @method self withDryRun(mixed $dryRun)
 *
 * Explain, 是否开启Explain执行计划分析 (default true)
 * @method self withExplain(mixed $explain)
 *
 * ExplainFormat [json, traditional] (default "traditional")
 ...
 *
 * ListHeuristicRules, 打印支持的评审规则列表
 * @method self withListHeuristicRules(mixed $listHeuristicRules)
 *
 * ListReportTypes, 打印支持的报告输出类型
 * @method self withListReportTypes(mixed $listReportTypes)
 *
 * ListRewriteRules, 打印支持的重写规则列表
 * @method self withListRewriteRules(mixed $listRewriteRules)
 *
 * ListTestSqls, 打印测试case用于测试
 * @method self withListTestSqls(mixed $listTestSqls)
 *
 * LogLevel, 日志级别, [0:Emergency, 1:Alert, 2:Critical, 3:Error, 4:Warning, 5:Notice, 6:Informational, 7:Debug] (default 3)
 ...
 *
 * log stack traces for errors
 * @method self withLogErrStacks(mixed $logErrStacks)
 *
 * size in bytes at which logs are rotated (glog.MaxSize) (default 1887436800)
 ...
 *
 * OnlySyntaxCheck, 只做语法检查不输出优化建议
 * @method self withOnlySyntaxCheck(mixed $onlySyntaxCheck)
 *
 * Print configs
 * @method self withPrintConfig(mixed $printConfig)
 *
 * Profiling, 开启数据采样的情况下在测试环境执行Profile
 * @method self withProfiling(mixed $profiling)
 *
 * 待评审的 SQL 或 SQL 文件，如 SQL 中包含特殊字符建议使用文件名。
 ...
 *
 * Sampling, 数据采样开关
 * @method self withSampling(mixed $sampling)
 *
 * SamplingCondition, 数据采样条件，如： WHERE xxx LIMIT xxx
 ...
 *
 * ShowLastQueryCost
 * @method self withShowLastQueryCost(mixed $showLastQueryCost)
 *
 * ShowWarnings
 * @method self withShowWarnings(mixed $showWarnings)
 *
 * SpaghettiQueryLength, SQL最大长度警告，超过该长度会给警告 (default 2048)
 ...
 *
 * Trace, 开启数据采样的情况下在测试环境执行Trace
 * @method self withTrace(mixed $trace)
 *
 * UkPrefix (default "uk_")
 * @method self withUniqueKeyPrefix(string $uniqueKeyPrefix)
 *
 * Verbose
 * @method self withVerbose(mixed $verbose)
 *
 * Print version info
 * @method self withVersion(mixed $version)
 *
 * Help
 * @method self withHelp(mixed $help)
 *
 * AllowCharsets (default "utf8,utf8mb4")
