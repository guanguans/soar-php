...
class Soar implements \Guanguans\SoarPHP\Contracts\Soar
{
    ...
    {
        if (
            isset($this->options['-test-dsn'])
            && isset($this->options['-test-dsn']['disable'])
            && true !== $this->options['-test-dsn']['disable']) {
            return $this->options['-test-dsn'];
        }

        if (
            isset($this->options['-online-dsn'])
            && isset($this->options['-online-dsn']['disable'])
            && true !== $this->options['-online-dsn']['disable']) {
